...
from v3.evidence.entities import EvidenceItem, FairValueSignal, RuleGraph
...
class NumericRoute:
    ...
    def _barrier_probability(
        ...
        t_years = time_to_expiry_hours / (365 * 24)
        ...
        # Z-score
        z = (ln_sk + mu * t_years) / sigma_sqrt_t
...
class AnomalyDetector:
    ...
    async def classify(
        ...
        2. regime_shift - Market conditions have fundamentally changed (e.g., volatility spike)
