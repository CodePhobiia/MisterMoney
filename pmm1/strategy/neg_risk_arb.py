...
class NegRiskArbDetector:
    ...
    def __init__(
        ...
        epsilon: float = 0.005,  # Min edge to execute
    ...
    def check_buy_no_sell_yes(
        ...
        for outcome in other_outcomes:
            ...
            total_bid_yes += yes_bid.price_float
            total_exit_fees += self._estimate_fee(yes_bid.price_float)
    ...
    def check_buy_yes_sell_no(
        ...
        for outcome in other_outcomes:
            ...
            total_ask_yes += yes_ask.price_float
            total_entry_fees += self._estimate_fee(yes_ask.price_float)
