...
from v3.evidence.entities import SourceDocument, EvidenceItem
...
class EvidenceCollector:
    ...
    def __init__(
        ...
        # Rate limiting state
        self.search_count = 0
        self.search_reset_time = datetime.now(timezone.utc)
    ...
    async def _has_fresh_evidence(
        ...
        try:
            ...
            age = datetime.now(timezone.utc) - most_recent.ts_observed
