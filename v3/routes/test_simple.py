...
async def test_simple_route():
    ...
    market = MarketMeta(
        ...
        description="This market resolves YES if the price of Bitcoin (BTC) reaches or exceeds $150,000 at any point before June 30, 2026, 11:59 PM ET.",
        resolution_source="CoinGecko",
        end_date=datetime(2026, 6, 30, 23, 59, 59),
        rules="This market resolves YES if the price of Bitcoin (BTC) reaches $150,000 at any point before June 30, 2026, 11:59 PM ET, as reported by CoinGecko. The price must be the spot price in USD. Futures, derivatives, or other Bitcoin-related instruments do not count.",
        clarifications=[
    ...
    evidence_items = [
        EvidenceItem(
            ...
            polarity="YES",
            claim="Bitcoin surged to $98,000 on March 5, 2026, driven by institutional adoption and BlackRock's latest BTC ETF inflows of $2.1B.",
            reliability=0.85,
            freshness_hours=2.0,
        ),
        EvidenceItem(
            ...
            ts_observed=datetime.utcnow(),
            polarity="YES",
            claim="Analysts at JPMorgan predict Bitcoin could reach $175,000 by Q3 2026 if current adoption trends continue.",
            reliability=0.78,
        ...
        EvidenceItem(
            ...
            ts_observed=datetime.utcnow(),
            polarity="NO",
            claim="Federal Reserve Chairman warns of potential crypto regulation that could dampen BTC rally. Markets reacted with a 3% pullback.",
            reliability=0.72,
            freshness_hours=6.0,
        ),
        EvidenceItem(
            ...
            ts_observed=datetime.utcnow(),
            polarity="MIXED",
            claim="Technical analysis shows BTC at resistance level around $100k. Some analysts see breakout potential, others warn of correction risk.",
            reliability=0.65,
    ...
    print(f"  ✅ Orchestrator returned signal")
    ...
    print("TEST SUMMARY")
    print("="*80)
    print(f"✅ Provider initialization: PASS")
    print(f"✅ Simple route blind pass (Sonnet): PASS")
    print(f"✅ Simple route judge pass (GPT-5.4): PASS")
    print(f"✅ Change detector scenarios: PASS (3/3)")
    print(f"✅ Orchestrator routing: PASS")
