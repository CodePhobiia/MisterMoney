    ...
    try:
        ...
        evidence_items = [
            EvidenceItem(
                ...
                doc_id=doc_id,
                ts_event=datetime.now(timezone.utc) - timedelta(hours=2),
                polarity="YES",
            ...
            EvidenceItem(
                ...
                condition_id="COND_001",
                doc_id=doc_id,
                ts_event=datetime.now(timezone.utc) - timedelta(hours=1),
                polarity="NO",
        ...
        print(f"   ✓ Retrieved rule graph: {retrieved_rule.source_name if retrieved_rule else 'None'}")
        ...
        # Extract claims
        full_text = "Revenue increased by 22.5% in Q4. The company became the largest provider in the sector."
