...
class FillCalibrator:
    ...
    async def compute_actual_fill_rates(self) -> dict[str, dict[str, Any]]:
    ...
    async def compute_calibration(self, fill_hazard: Any) -> dict[str, float]:
    ...
    async def apply_calibration(self, fill_hazard: Any, corrections: dict[str, Any]) -> None:
