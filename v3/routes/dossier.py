...
class DossierRoute:
        ...
        try:
            ...
            for doc in documents:
                doc_dict = {
                    ...
                    "content_summary": "(Full content would be loaded here)"  # TODO: Load from text_path
                }
    ...
    async def resolve_disagreement(self,
        ...
        if diff < 0.05:
            ...
            final_p = (synthesis.p_hat + challenge.p_hat) / 2
            ...
            final_estimate = BlindEstimate(
                ...
                reasoning_summary=f"Synthesis and challenge agree within 5% (diff={diff:.3f}). Using average.",
            )
...
{{
  ...
  "challenge_weight": 0.4
            ...
            judge_system = """You are a senior analyst adjudicating disagreements between two probability estimates.
...
Output ONLY valid JSON."""
            ...
            final_estimate = BlindEstimate(
                p_hat=judge_data.get("p_hat", (synthesis.p_hat + challenge.p_hat) / 2),
